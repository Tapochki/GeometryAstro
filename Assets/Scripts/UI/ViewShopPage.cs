...
using ChebDoorStudio.UI.Views.Objects;
...
namespace ChebDoorStudio.UI.Views
{
    public class ViewShopPage : View
    {
        ...
        private ShopItem _removeAdItem;
        ...
        public void Construct(AdvertismentSystem advertismentSystem, LoadObjectsSystem loadObjectsSystem,
                                ...
                                DataSystem dataSystem, VaultSystem vaultSystem,
                                InitialGameData initialGameData, PurchasingSystem purchasingSystem)
        {
        ...
        public override void Initialize()
        {
            ...
            _shopItemPrefab = _loadObjectsSystem.GetObjectByPath<ShopItem>("Prefabs/ShopItem");
            _shopData = _loadObjectsSystem.GetObjectByPath<ShopData>("Data/ShopData");

            _removeAdItem = _shopItemsParent.Find("ShopItem_RemoveAd").GetComponent<ShopItem>();
            ...
            _removeAdItem.OnItemSelectedEvent += RemoveAdItemOnSelectHandler;
        }
