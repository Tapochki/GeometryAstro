...
namespace ChebDoorStudio.UI.Views
{
    public sealed class ViewMenuPage : View
    {
        ...
        public void Construct(SceneSystem sceneSystems, DataSystem dataSystem,
                                GameStateSystem gameStateSystem, ScoreSystem scoreSystem,
                                LocalisationSystem localisationSystem, VaultSystem vaultSystem)
        {
            ...
            _scoreSystem.OnBestScoreChangedEvent += OnBestScoreChangedEventHandler;
