...
namespace ChebDoorStudio.UI.Views
{
    public class ViewGamePage : View
    {
        ...
        [Inject]
        public void Construct(LocalisationSystem localisationSystem, GameStateSystem gameStateSystem,
                                InputsSystem inputsSystem, ScoreSystem scoreSystem,
                                PlayerComponent playerComponent, ItemSpawnSystem itemSpawnSystem,
                                VaultSystem vaultSystem, PauseSystem pauseSystem)
        {
            ...
            _scoreSystem.OnScoreUpdateEvent += OnScoreUpdateEventHandler;
        ...
        {
            _soundSystem.PlaySound(Settings.Sounds.PlayerChangeDirection);
