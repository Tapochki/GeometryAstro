...
namespace TandC.GeometryAstro.Gameplay 
{
    ...
    {
        Enemy Build(Enemy enemy, EnemyData data, Action<Enemy> onDeathEvent, Transform target, Vector2 rotationDirection);
    }

    public abstract class EnemyBuilderBase : IEnemyBuilder
    {
        public Enemy Build(Enemy enemy, EnemyData data, Action<Enemy> onDeathEvent,
