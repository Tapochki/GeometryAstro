...
{
    public class MachineGunBuilder : ActiveSkillBuilder<MachineGun>
    {
        protected override ActiveSkillType _activeSkillType => ActiveSkillType.MachineGun;

        private Transform _playerTransformSkills;

        private int _startBulletPreloadCount = 20;

        public MachineGunBuilder(Transform playerTransformSkills) 
        {
